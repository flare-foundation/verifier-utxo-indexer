# Generated by Django 4.2 on 2024-09-18 09:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vin_previous_txid",
                    utxo_indexer.models.model_utils.HexString32ByteField(db_column="vinPreviousTxid", max_length=64),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "block_hash",
                    utxo_indexer.models.model_utils.HexString32ByteField(
                ...
                (
                    "previous_block_hash",
                    utxo_indexer.models.model_utils.HexString32ByteField(db_column="previousBlockHash", max_length=64),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_reference",
                    utxo_indexer.models.model_utils.HexString32ByteField(db_column="paymentReference", max_length=64),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["block_number"], name="utxo_indexe_blockNu_331255_idx"),
        ),
        migrations.AddIndex(
            model_name="utxotransaction",
            index=models.Index(fields=["timestamp"], name="utxo_indexe_timesta_4e0245_idx"),
        ),
        migrations.AddIndex(
            model_name="utxotransaction",
            index=models.Index(fields=["payment_reference"], name="utxo_indexe_payment_c4185f_idx"),
        ),
        migrations.AddIndex(
            model_name="utxotransaction",
            index=models.Index(fields=["transaction_type"], name="utxo_indexe_transac_b5a07e_idx"),
        ),
        migrations.AddIndex(
            model_name="utxoblock",
            index=models.Index(fields=["block_number"], name="utxo_indexe_blockNu_4ad566_idx"),
        ),
        migrations.AddIndex(
            model_name="utxoblock",
            index=models.Index(fields=["timestamp"], name="utxo_indexe_timesta_7390df_idx"),
        ),
        migrations.AddIndex(
            model_name="utxoblock",
            index=models.Index(fields=["previous_block_hash"], name="utxo_indexe_previou_b19022_idx"),
        ),
        migrations.AddField(
            model_name="transactionoutput",
            name="transaction_link",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="utxo_indexer.utxotransaction"),
        ),
        migrations.AddField(
            model_name="transactioninputcoinbase",
            name="transaction_link",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="utxo_indexer.utxotransaction"),
        ),
        migrations.AddField(
